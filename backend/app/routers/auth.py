...
from app.schemas.auth import UserCreate, UserResponse, Token, LoginRequest, RegisterRequest
...
async def login(
    ...
    access_token_expires = timedelta(minutes=settings.API_PILOT_ACCESS_TOKEN_EXPIRE_MINUTES)
